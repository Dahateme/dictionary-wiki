...
``` toml
dict_label = "PTS"
word = "uddha FIXME double"
summary = "Uddhaṃ & Uddha˚ (indecl.) high up, on top, above ("
see_also = ["adho", "ubbhaṃ", "pāda", "mukha", "lomin", "virecana", "suddha", "pāda", "bhāgiya", "saṃyojana", "virecana", "sota"]
```
...
1. (of *space*) up aloft, on top, above (opp. adho) Vin.iii.121; Kp\-a.248 (= upari)  
   ■ In contrast with adho (above → below DN.i.23, DN.i.153, DN.i.251; Vism.176 (u. adho tiriyaṃ expld.) DN\-a.i.98 (see also *[adho](adho.md)*)  
...
*Note* (cp Trenckner, *Notes* 60). In certain cases we find *[ubbhaṃ](ubbhaṃ.md)* for uddhaṃ. Notice the foll.: ubbhaṃ yojanaṃ uggato Ja.v.269; ubbhaṭṭhako hoti “standing erect” DN.i.167; MN.i.78; ubbhamukhu “mouth (face) upwards”, turned upwards SN.iii.238; Mil.122.

1. *uddha˚*; in: *\-gāmin* going upwards SN.v.370 sq *cchiddaka (\-vātapānā)* (windows) having openings above Dhp\-a.i.211. *\-[pāda](pāda.md)* heels upwards either with *adhosira* (head down) AN.iv.133, or *avansira* Vv.52#25 (variant reading); Ja.i.233. *\-[mukha](mukha.md)* turned upwards, adv. ˚ā upwards or backwards (of a river) Mil.295 (Gangā u. sandati; in same context ubbha˚ Mil.122). *\-[lomin](lomin.md)* “having hair on the upper side”, a kind of couch or bed (or rug on a couch Vin.i.192 = Vin.ii.163, Vin.ii.169. So is prob. to be read for uddalomī (q.v.). *\-[virecana](virecana.md)* action of an emetic (lit. throwing up) (opp. adho\-virecana of a purgative) DN.i.12 (= uddhaṃ dosānaṃ nīharaṇaṃ DN\-a.i.98); Dhp\-a.iii.126; Snp\-a.86 *\-[suddha](suddha.md)* clean on top Vin.ii.152
2. *uddhaṃ˚*; in *\-āghātanika* an after\-deather, a teacher who maintains that the soul exists after death DN.i.31, cp. DN\-a.i.119 *\-[pāda](pāda.md)* feet up (& head down) Vv.52#25 (variant reading uddha˚) *\-[bhāgiya](bhāgiya.md)* belonging to the upper part (opp. oram˚): see *[saṃyojana](saṃyojana.md)*. *\-[virecana](virecana.md)* variant reading BB. at Snp\-a.86 for uddha˚ *\-sara(ṃ)* (adv.) with raised or lofty voice, lit. “sounding high” Snp.901, see Mnd.315. *\-[sota](sota.md)* (adj.) one who is going upwards in the stream of life (cp. BSk. ūrdhvasrotaḥ Mahāvy § 46)

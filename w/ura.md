...
dict_label = "NCPED"
word = "ura"
summary = "the chest, the breast."
grammar_comment = "neuter (& m.)"
also_written_as = ["uras"]
```
...
dict_label = "PTS"
word = "ura"
summary = "Ura & Uro masculine & neuter 1. the breast, chest"
see_also = ["cakka"]
```
...
* *\-[cakka](cakka.md)* an iron wheel (put on the chest), as an instrument of torture in Niraya Ja.i.363, Ja.i.414

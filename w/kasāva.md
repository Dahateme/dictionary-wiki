...
dict_label = "NCPED"
word = "kasāva"
summary = "an astringent substance; an astringent decoction ("
...
dict_label = "PTS"
word = "kasāva"
summary = "Kasāya & Kasāva 1. a kind of paste or gum used in"
see_also = ["rasa", "gandha", "rasa", "vaṇṇa"]
```
...
* *\-[rasa](rasa.md)* reddishyellow dye Ja.ii.198; *(kasāva)\-odaka* an astringent decoction Vin.i.205;
* *\-[gandha](gandha.md)* having a pungent smell Vin.i.277;
* *\-[rasa](rasa.md)* having an astringent taste ibid.
* *\-[vaṇṇa](vaṇṇa.md)* of reddish\-yellow colour ibid.
